                    ...
                    <div class="w-full">
                        <form class="bg-white shadow-md rounded px-8 pt-6 pb-8" @submit.prevent="submit">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="description" name="description" placeholder="Description" v-model="form.description"></textarea>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="ml-4 mb-4 p-4 border-2 rounded-md" v-for="(episode, index) in form.episodes" :key="index">
                                    ...
                                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" :id="'title'+index" name="title" type="text" placeholder="Titre" v-model="form.episodes[index].title">
                                    ...
                                    <textarea class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" :id="'description'+index" name="description" type="text" placeholder="Description" v-model="form.episodes[index].description"></textarea>
                                    ...
                                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" :id="'video_url'+index" name="video_url" type="text" placeholder="ex: wwww.youtube.com/?watch:1268844dd" v-model="form.episodes[index].video_url">
...
<script>
    ...
    export default defineComponent({
        ...
        methods: {
            submit(e) {
                Inertia.post(route('courses.store'), this.form)
                this.resetForm()
            },
            addEpisode(e){
